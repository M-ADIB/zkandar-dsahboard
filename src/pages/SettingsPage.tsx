...
import {
    ...
    Briefcase, Globe, Calendar, Settings, CreditCard, FileText,
} from 'lucide-react'
...
type SettingsTab = 'profile' | 'team' | 'notifications' | 'security' | 'billing' | 'dev'
                    ...
                    <div className="max-w-3xl space-y-6">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="font-heading font-bold">Billing & Invoices</h2>
                            </div>
