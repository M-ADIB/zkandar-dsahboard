            ...
            <section className="pt-36 pb-16 md:pt-44 md:pb-20 border-b border-white/[0.04] bg-black">
                <div className="container mx-auto px-5 sm:px-6 max-w-5xl">
                    ...
                    <div className="flex flex-wrap items-end gap-4 mt-4">
                        <h1 className="font-heading font-black uppercase text-[clamp(2rem,6vw,4.5rem)] leading-[0.93]">
                            REAL PROJECTS.<br /><span className="text-lime">REAL AI OUTPUT.</span>
                        </h1>
                        <LimeBar />
                    </div>
                    <p className="text-gray-400 text-sm sm:text-base mt-5 max-w-xl leading-relaxed">
            ...
            <section className="py-16 md:py-24 border-t border-white/[0.04] bg-[#050505]">
                <div className="container mx-auto px-5 sm:px-6 max-w-5xl">
                    <FadeIn className="mb-12">
                        <MicroLabel>Hear From Our Participants</MicroLabel>
                        <div className="flex flex-wrap items-end gap-4 mt-4">
                            <h2 className="font-heading font-black uppercase text-[clamp(1.8rem,5vw,3.5rem)] leading-[0.95]">
                                SPRINT WORKSHOP<br /><span className="text-lime">TESTIMONIALS.</span>
                            </h2>
                            <LimeBar />
                        </div>
                        <p className="text-gray-500 text-sm mt-3">9 workshops. 9 real results.</p>
                    </FadeIn>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {WORKSHOPS.map((w, i) => (
                            <FadeIn key={w.id} delay={i * 0.05}>
                                <div className="rounded-2xl overflow-hidden border border-white/[0.06] bg-black aspect-video hover:border-lime/20 transition-colors">
                                    <iframe
