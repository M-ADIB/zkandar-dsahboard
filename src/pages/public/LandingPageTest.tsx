...
const CASE_STUDIES: CaseStudy[] = [
    ...
    },
    {
        ...
        location: 'India',
        tagline: 'Raw studio product shots fed into AI. What came out the other side is an entirely new visual identity.',
        previewImgs: [
        ...
        slides: [
            { vimeoId: '1185031432', stepLabel: '▶', category: 'Walkthrough', title: 'Full Video Walkthrough', caption: 'A complete AI-directed walkthrough — from raw studio photography to photorealistic product renders.' },
            // ── Before ────────────────────────────────────────────
            { img: '/casestudies/akshay/before-1.jpg',  stepLabel: '01', category: 'Before', title: 'Studio Shot 01',  caption: 'Raw product photography. Clean studio setup, white background. The input the AI has to work with.' },
            { img: '/casestudies/akshay/before-2.jpg',  stepLabel: '02', category: 'Before', title: 'Studio Shot 02',  caption: '' },
            { img: '/casestudies/akshay/before-3.jpg',  stepLabel: '03', category: 'Before', title: 'Studio Shot 03',  caption: '' },
            { img: '/casestudies/akshay/before-4.jpg',  stepLabel: '04', category: 'Before', title: 'Studio Shot 04',  caption: '' },
            { img: '/casestudies/akshay/before-5.jpg',  stepLabel: '05', category: 'Before', title: 'Studio Shot 05',  caption: '' },
            { img: '/casestudies/akshay/before-6.jpg',  stepLabel: '06', category: 'Before', title: 'Studio Shot 06',  caption: '' },
            { img: '/casestudies/akshay/before-7.jpg',  stepLabel: '07', category: 'Before', title: 'Studio Shot 07',  caption: '' },
            { img: '/casestudies/akshay/before-8.jpg',  stepLabel: '08', category: 'Before', title: 'Studio Shot 08',  caption: '' },
            { img: '/casestudies/akshay/before-9.jpg',  stepLabel: '09', category: 'Before', title: 'Studio Shot 09',  caption: '' },
            { img: '/casestudies/akshay/before-10.jpg', stepLabel: '10', category: 'Before', title: 'Studio Shot 10',  caption: '' },
            { img: '/casestudies/akshay/before-11.jpg', stepLabel: '11', category: 'Before', title: 'Studio Shot 11',  caption: '' },
            { img: '/casestudies/akshay/before-12.jpg', stepLabel: '12', category: 'Before', title: 'Studio Shot 12',  caption: '' },
            { img: '/casestudies/akshay/before-13.jpg', stepLabel: '13', category: 'Before', title: 'Studio Shot 13',  caption: '' },
            { img: '/casestudies/akshay/before-14.jpg', stepLabel: '14', category: 'Before', title: 'Studio Shot 14',  caption: '' },
            { img: '/casestudies/akshay/before-15.jpg', stepLabel: '15', category: 'Before', title: 'Studio Shot 15',  caption: '' },
            { img: '/casestudies/akshay/before-16.jpg', stepLabel: '16', category: 'Before', title: 'Studio Shot 16',  caption: '' },
            { img: '/casestudies/akshay/before-17.jpg', stepLabel: '17', category: 'Before', title: 'Studio Shot 17',  caption: '' },
            { img: '/casestudies/akshay/before-18.jpg', stepLabel: '18', category: 'Before', title: 'Studio Shot 18',  caption: 'Every piece documented. This is the raw material — before AI touched it.' },
            // ── After ─────────────────────────────────────────────
            { img: '/casestudies/akshay/after-1.jpg',   stepLabel: '19', category: 'After',  title: 'B.FORM Render 01', caption: 'AI transforms the studio shot into a full photorealistic product render. Same object. Entirely different world.' },
            { img: '/casestudies/akshay/after-2.jpg',   stepLabel: '20', category: 'After',  title: 'B.FORM Render 02', caption: '' },
            { img: '/casestudies/akshay/after-3.jpg',   stepLabel: '21', category: 'After',  title: 'B.FORM Render 03', caption: '' },
            { img: '/casestudies/akshay/after-4.jpg',   stepLabel: '22', category: 'After',  title: 'B.FORM Render 04', caption: '' },
            { img: '/casestudies/akshay/after-5.jpg',   stepLabel: '23', category: 'After',  title: 'B.FORM Render 05', caption: '' },
            { img: '/casestudies/akshay/after-6.jpg',   stepLabel: '24', category: 'After',  title: 'B.FORM Render 06', caption: '' },
            { img: '/casestudies/akshay/after-7.jpg',   stepLabel: '25', category: 'After',  title: 'B.FORM Render 07', caption: '' },
            { img: '/casestudies/akshay/after-8.jpg',   stepLabel: '26', category: 'After',  title: 'B.FORM Render 08', caption: '' },
            { img: '/casestudies/akshay/after-9.jpg',   stepLabel: '27', category: 'After',  title: 'B.FORM Render 09', caption: '' },
            { img: '/casestudies/akshay/after-10.jpg',  stepLabel: '28', category: 'After',  title: 'B.FORM Render 10', caption: '' },
            { img: '/casestudies/akshay/after-11.jpg',  stepLabel: '29', category: 'After',  title: 'B.FORM Render 11', caption: '' },
            { img: '/casestudies/akshay/after-12.jpg',  stepLabel: '30', category: 'After',  title: 'B.FORM Render 12', caption: '' },
            { img: '/casestudies/akshay/after-13.jpg',  stepLabel: '31', category: 'After',  title: 'B.FORM Render 13', caption: '' },
            { img: '/casestudies/akshay/after-14.jpg',  stepLabel: '32', category: 'After',  title: 'B.FORM Render 14', caption: 'The full library. Client-ready product imagery — generated entirely with AI.' },
        ],
    },
    {
        id: 'evan',
