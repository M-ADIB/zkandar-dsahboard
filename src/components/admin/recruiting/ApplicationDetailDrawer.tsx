                ...
                >
                    ...
                    <div className="flex items-start justify-between p-6 border-b border-white/5 bg-[#111] shrink-0">
                        <div>
                            ...
                            <p className="text-gray-400 text-sm mt-0.5">{application.gender} · {application.country} · {application.timezone}</p>
                        </div>
                                ...
                                {application.instagram_url && (
                                    <div className="p-4 bg-[#111] border border-white/5 rounded-xl flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a
                                                href={application.instagram_url.startsWith('http') ? application.instagram_url : `https://${application.instagram_url}`}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-white text-sm hover:text-[#D0FF71] transition-colors flex items-center gap-1"
                                            >
