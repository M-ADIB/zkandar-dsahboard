                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8 mb-12">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <div className="flex items-center gap-3 mt-5">
                            ...
                            <a href="https://www.linkedin.com/in/zkandar/" target="_blank" rel="noopener noreferrer"
                                className="w-8 h-8 rounded-full border border-white/[0.08] flex items-center justify-center text-gray-500 hover:text-white hover:border-white/20 transition">
                                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {Object.entries(FOOTER_LINKS).map(([section, links]) => (
                        <div key={section}>
                            <p className="text-[0.6rem] font-bold uppercase tracking-[0.2em] text-gray-600 mb-4">{section}</p>
                            <ul className="space-y-3">
                                {links.map(l => (
                                    <li key={l.label}>
                                        <a href={l.href} className="text-sm text-gray-500 hover:text-white transition">{l.label}</a>
                                    </li>
                                ))}
                            </ul>
                        </div>
