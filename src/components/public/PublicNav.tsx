                ...
                >
                    ...
                    <div className="flex items-center gap-2.5 shrink-0">
                        ...
                        <button
                            ...
                            className="flex flex-col justify-center gap-[5px] w-7 h-7 rounded-md hover:bg-white/5 transition-colors p-1.5"
                        >
                            <motion.span
                ...
                {menuOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed inset-x-4 sm:left-1/2 sm:-translate-x-1/2 sm:w-full sm:max-w-[1320px] z-50 rounded-md bg-black/90 backdrop-blur-2xl border border-white/[0.09] px-4 pt-4 pb-5 flex flex-col gap-1 shadow-[0_16px_48px_rgba(0,0,0,0.5)]"
                        >
                            ...
                            {/* CTA inside menu — visible on mobile (sm:hidden mirrors the bar CTA) */}
                            <div className="mt-2 pt-3 border-t border-white/[0.06] sm:hidden">
                                <a
                                    href="/find-your-path"
                                    onClick={() => setMenuOpen(false)}
