        ...
        <>
            ...
            >
                <motion.nav
                    ...
                    className={`pointer-events-auto w-full max-w-[1100px] px-4 sm:px-6 py-2.5 flex items-center justify-between backdrop-blur-2xl rounded-sm border transition-all duration-500 ${
                        scrolled
                ...
                >
                    ...
                    <div className="hidden md:flex items-center gap-0.5">
                        {NAV_LINKS.map((link, i) => (
                            <motion.a
                                ...
                                className={`relative px-3 py-1.5 rounded-sm text-[0.63rem] font-bold uppercase tracking-[0.14em] transition-colors duration-200 ${
                            ...
                            >
                                {isActive(link.href) && (
                                    <motion.span
                                        ...
                                        className="absolute inset-0 rounded-sm bg-lime/10 border border-lime/20"
                    ...
                    <div className="flex items-center gap-2.5 shrink-0">
                        <motion.a
                            ...
                            whileTap={{ scale: 0.96 }}
                            className="px-3.5 py-1.5 rounded-sm bg-white text-black font-bold text-[0.62rem] uppercase tracking-wider hover:bg-lime hover:shadow-[0_0_18px_rgba(208,255,113,0.4)] transition-all duration-300"
                        >
                            See Where You're At
                        </motion.a>
                        ...
                        <button
                            ...
                            className="md:hidden flex flex-col justify-center gap-[5px] w-7 h-7 rounded-sm hover:bg-white/5 transition-colors p-1.5"
                        >
                            <motion.span
            ...
            <AnimatePresence>
                {mobileOpen && (
                    <motion.div
                        ...
                        className="fixed inset-x-4 sm:left-1/2 sm:-translate-x-1/2 sm:w-full sm:max-w-[1100px] z-40 rounded-sm bg-black/80 backdrop-blur-2xl border border-white/[0.09] px-4 pt-4 pb-5 flex flex-col gap-1 md:hidden shadow-[0_16px_48px_rgba(0,0,0,0.5)]"
                    >
                        {NAV_LINKS.map((link, i) => (
                            <motion.a
                                key={link.label}
                                ...
                                className={`px-4 py-2.5 rounded-sm text-sm font-bold uppercase tracking-[0.12em] transition-colors duration-200 ${
                                    isActive(link.href)
                        ...
                        <div className="mt-2 pt-3 border-t border-white/[0.06]">
                            <a
                                href="/find-your-path"
                                onClick={() => setMobileOpen(false)}
                                className="block w-full text-center px-4 py-3 rounded-sm bg-white text-black font-bold text-xs uppercase tracking-wider hover:bg-lime transition-colors duration-200"
                            >
                                See Where You're At
                            </a>
                        </div>
